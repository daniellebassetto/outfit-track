...
public class InputCreateCustomer
{
    ...
    [JsonConstructor]
    public InputCreateCustomer(string firstName, string? lastName, DateTime birthDate, string cpf, string street, string? complement, string neighborhood, string number, string cityName, EnumStateAbbreviationBrazil stateAbbreviation, string? postalCode, string rg, string mobilePhoneNumber, string? email)
    {
        FirstName = firstName;
        LastName = lastName;
        BirthDate = birthDate;
